- DONE set up [[GitHub]] with [[SSH]]
	- ```bash
	  ...
	  ssh-add --apple-use-keychain ~/.ssh/${KEY_FILENAME:-id_ed25519} # on macOS
	  
	  
	  ```
	- Reference: [Connect with SSH / Generating a new SSH key and adding it to the ssh-agent](https://docs.github.com/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent#generating-a-new-ssh-key)
