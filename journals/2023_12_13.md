...
- TODO [#B] send photo for Slack profile picture to Sayli Achrekar
  DEADLINE: <2023-12-20 Wed>
- DONE setup [[Syncthing]] on Procedure's Macbook Air
- TODO [#C] #explore [[Raycast]]
- TODO [#C] #explore these [coding assistants](https://sourceforge.net/software/ai-coding-assistants/)
- TODO [#C] #explore the following extensions
